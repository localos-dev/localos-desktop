import{d4 as b,d7 as d,dq as u,d8 as x,d9 as v,db as L,cW as O,cU as g,cP as V,dU as a,da as c,dd as H,cN as h,cL as E,de as I,dB as K,cO as y,c_ as Q,cZ as Z,dm as G,d5 as Y,d6 as J,dp as X,d$ as M,e0 as q,cR as ee}from"./index-83f-vt_I.js";import"./index-fTp_rDyW.js";import"./index-DJLYHuc1.js";import{S as P}from"./SwapController-lbhf0imj.js";const te=b`
  :host {
    width: 100%;
    height: 100px;
...
`;var j=function(e,t,i,o){var r=arguments.length,n=r<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,o);else for(var l=e.length-1;l>=0;l--)(s=e[l])&&(n=(r<3?s(n):r>3?s(t,i,n):s(t,i))||n);return r>3&&n&&Object.defineProperty(t,i,n),n};let N=class extends v{constructor(){super(...arguments),this.params=h.state.data?.send}render(){return c` <wui-text variant="sm-regular" color="secondary">Details</wui-text>
      ...
      ></wui-list-content>`:null}onNetworkClick(t){t&&!this.params&&h.push("Networks",{network:t})}};N.styles=ae;j([d()],N.prototype,"receiverAddress",void 0);j([d({type:Object})],N.prototype,"caipNetwork",void 0);j([u()],N.prototype,"params",void 0);N=j([x("w3m-wallet-send-details")],N);const le=b`
  wui-avatar,
  wui-image {
    display: ruby;
    width: 32px;
...
`;var ue=function(e,t,i,o){var r=arguments.length,n=r<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,o);else for(var l=e.length-1;l>=0;l--)(s=e[l])&&(n=(r<3?s(n):r>3?s(t,i,n):s(t,i))||n);return r>3&&n&&Object.defineProperty(t,i,n),n};let F=class extends v{constructor(){super(),this.unsubscribe=[],this.unsubscribe.push()}render(){return c`
    ...
    `}onCloseClick(){K.close()}};F.styles=ce;F=ue([x("w3m-send-confirmed-view")],F);export{F as W3mSendConfirmedView,C as W3mSendSelectTokenView,p as W3mWalletSendPreviewView,f as W3mWalletSendView};
