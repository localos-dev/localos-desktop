import{dB as x,e1 as te,cN as c,cP as ne,d4 as g,d5 as j,d8 as m,d9 as b,da as d,d7 as l,dp as k,cY as z,dq as u,d6 as se,cU as f,dc as D,dm as L,dZ as le,dH as V,cR as U,dy as R,d0 as F,df as ce,cO as A,dD as T,dW as q,dn as de,de as ie,e2 as ue,e3 as he}from"./index-83f-vt_I.js";import{P as _}from"./index-CgVosaaV.js";import{S as pe}from"./SwapController-lbhf0imj.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
