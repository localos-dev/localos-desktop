import{d4 as L,d7 as k,dq as l,d8 as O,d9 as _,d0 as E,dy as h,dD as W,cN as f,c_ as T,da as c,dE as F,cW as v,dF as D,cY as N,dG as R,dp as $,cU as d,cP as P,dH as j,cR as u,dI as U,cO as C,dJ as M,dB as I,dn as x}from"./index-83f-vt_I.js";const q=L`
  :host {
...
`;var A=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let S=class extends _{constructor(){super(),this.unsubscribe=[],this.checked=R.state.isLegalCheckboxChecked,this.unsubscribe.push(R.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:i}=h.state,r=h.state.features?.legalCheckbox,n=!!(e||i)&&!!r&&!this.checked,a=n?-1:void 0;return c`
    ...
    `}};S.styles=z;A([l()],S.prototype,"checked",void 0);S=A([O("w3m-connect-socials-view")],S);const B=L`
  wui-logo {
    width: 80px;
    height: 80px;
